...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
    \item {\normalsize {LTE System Manager (LSM) Project - In Management Software \& Analytics Team }
        \begin{itemize}
            \item Functioning in the Telecom Domain as part of Network Management System in Element Management System (EMS), which handles one or more telecommunications network elements.
    ...
    \item {\normalsize {Research and Patents Works}
        \begin{itemize}
            ...
            \item Enlightened the team on advanced topics like ZK-SNKRKs, ZK-STARKs, Bulletproofs, etc. and designed various documents on the same.
        \end{itemize}
    }
...
\textbf{Kubernetes:} Kubernetes Pods, Deployments, Service, Jobs \& Cronjobs, Service Monitors, Ingress Controllers, Load balancers, SSL certificate, Cluster Issuers, API Gateways(Traefik); Kubectl, Kubens, Helm, Minikube;\\
...
\textbf{Amazon Web Services(AWS):} Lambda functions, S3 buckets, Elastic Kubernetes Service(EKS), Elastic Container Registry (ECR), Elastic Beanstalk(EB), Amazon API Gateways;\\
...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
    ...
    \item { \normalsize Conducted Android Study Jams at NIT Raipur on course Android Kotlin Fundamentals course on date March 15th, 2021. }
...
\begin{itemize}[noitemsep,nolistsep,leftmargin=*]
    ...
    \item { \normalsize \textbf{Finals:} Smart India Hackathon 2020. 
        \begin{itemize}
            \item \normalsize \href{https://github.com/siddharthshah3030/choukidar-owasp-security-chrome-extension}{\textbf{Chowkidar Chrome Extension:}} Developed a chrome extension to detect Top 10 OWASP Security vulnerabilities in a WebSite.
        \end{itemize}
    }
